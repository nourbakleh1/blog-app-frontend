...
import { updateComments } from "../../ApiCall/CommentsSlice";
...
const UpdateCommentModal = ({ setUpdateComment, commentForUpdate }) => {
  ...
  const formSubmitHandler = (e) => {
    ...
    const id=commentForUpdate?._id;
    dispatch(updateComments({id,text:{text}}));
  ...
  return (
    <div className="update-comment">
      <form onSubmit={formSubmitHandler} className="update-post-form">
        ...
        />
        <button type="submit" className="update-comment-btn bg-slate-600 w-fit m-auto">
          Edit Comment
        </button>
      </form>
    </div>
